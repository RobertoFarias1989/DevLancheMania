...
namespace DevLancheMania.Models
{
    [Table("Lanches")]
    public class Lanche
    {
        ...
        [MinLength(20,ErrorMessage ="Descrição de ter no mínimo {1} caracteres")]
        ...
        [MinLength(20, ErrorMessage = "Descrição detalhada de ter no mínimo {1} caracteres")]
