...
using DevLancheMania.ViewModels;
...
namespace DevLancheMania.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        public AdminPedidosController(DevLancheManiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DevLancheManiaContext.Pedidos'  is null.");
            }
            var pedido = await _context.Pedidos.FindAsync(id);
            if (pedido != null)
            {
