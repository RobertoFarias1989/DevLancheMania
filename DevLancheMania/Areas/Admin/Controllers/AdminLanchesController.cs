...
namespace DevLancheMania.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public AdminLanchesController(DevLancheManiaContext context)
        {
            _context = context;
        }
        ...
        //{
        //    var devLancheManiaContext = _context.Lanches.Include(l => l.Categoria);
        //    return View(await devLancheManiaContext.ToListAsync());
        //}
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DevLancheManiaContext.Lanches'  is null.");
            }
            var lanche = await _context.Lanches.FindAsync(id);
            if (lanche != null)
            {
