...
namespace DevLancheMania.Areas.Admin.Controllers
{
    ...
    {
        private readonly RelatorioVendasService _relatorio;

        public AdminRelatorioVendasController(RelatorioVendasService relatorio)
        {
        ...
        public async Task<IActionResult> RelatorioVendasSimples(DateTime? minDate, DateTime? maxDate)
        {
            ...
            var result = await _relatorio.FindByDateAsync(minDate, maxDate);
